package com.github.pmoerenhout.jsmpp.web.charset;
...
public class CharsetService {
  ...
  public static Charset getCharset(final String charsetName) {
    ...
    final Charset freenetCharset = new net.freeutils.charset.CharsetProvider().charsetForName(charsetName);
    if (freenetCharset != null) {
      return freenetCharset;
    }
    // I tried... but no luck
    return null;
  }
